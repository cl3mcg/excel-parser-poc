 ...
 * @returns {Array<ProbableColumn>} An array of objects representing the columns most likely to contain country data.
 * 
 * @example
...
const returnTheMostProbableCountryColumns = function (uniqueColumnsNamesArray) {
  ...
  const fuzzySet_headerNames_country = FuzzySet(headerNames_country);
